...
class Header extends Component {
    ...
    render() {
        return (
            <Fragment>
                {this.state.isPopup ? <div className='popup-direction-form'><Header withBackButton={true} title='Update Search' withSubHeader={false} handleGoBack={() => this.handleShowPopup(false)} /><div className='content global search-panel'><DirectionForm direction={this.props.direction} /></div></div> : null}
